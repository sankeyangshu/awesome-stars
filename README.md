...
- [wenps/auto-i18n-translation-plugins](https://github.com/wenps/auto-i18n-translation-plugins) - 网页自动翻译。支持（有道 / 谷歌 / 百度 / 空 /自定义）翻译器。兼容 webpack/vite/rollup，适配 所有编译成 JS 的 框架，支持插值，命名空间等，帮助你一键翻译项目。
