...
- [sep2/vite-plugin-taro](https://github.com/sep2/vite-plugin-taro) - Build WeChat/Alipay Mini Apps with the latest standard frontend stack: Vite 8, React 19, and Tailwind CSS v4.
...
- [zhe-qi/clhoria-template](https://github.com/zhe-qi/clhoria-template) - Production-ready Hono backend template that doubles as an AI agent harness — providing feedforward guides, feedback sensors, and progressive specialization to make AI coding agents reliably produce ar
...
- [yluiop123/orange](https://github.com/yluiop123/orange) - Orange is a Shadcn Admin UI built with Shadcn, Vite, React, Zustand, and React Router.
...
- [taroify/taroify](https://github.com/taroify/taroify) - Taroify 是移动端组件库 Vant 的 Taro 版本，两者基于相同的视觉规范，提供一致的 API 接口，助力开发者快速搭建小程序应用。
...
- [yudaocode/yudao-mall-uniapp](https://github.com/yudaocode/yudao-mall-uniapp) - 芋道商城，基于 Vue3 + Uniapp 实现，支持分销、拼团、砍价、秒杀、优惠券、积分、会员等级、小程序直播、页面 DIY 等功能，100% 开源
...
- [imwangfan/SnowAdmin](https://github.com/imwangfan/SnowAdmin) - SnowAdmin 一款基于 Vue3、TypeScript、Vite7、Pinia、Arco.Design 开源的后台管理框架，符合直觉的使用模式，使用目前最新技术栈开发。
